// Catalogo de productos (puedes reemplazar las URLs de las imágenes por las de tus archivos locales)
const products = [
    {
        id: 1,
...
// Manejar selección de talla y color en cada tarjeta
...
checkoutForm.addEventListener('submit', (e) => {
    ...
    const phone = "51987654321"; // Reemplazar con tu número real
